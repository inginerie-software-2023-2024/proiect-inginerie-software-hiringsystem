...
const updatePersonalDetails = async (
  ...
  const res = await fetch(
    `${process.env.BACKEND_URL}/api/v1/candidate/profile/update/details/${id}`,
    {
      method: "POST",
      headers: {
...
const updateAcademicBackground = async (
  ...
  const res = await fetch(
    `${process.env.BACKEND_URL}/api/v1/candidate/profile/update/academic/${id}`,
    {
      method: "POST",
      headers: {
        Authorization: authorizationHeader,
...
const updateWorkExperience = async (
  ...
  const res = await fetch(
    `${process.env.BACKEND_URL}/api/v1/candidate/profile/update/work/${id}`,
    {
      method: "POST",
      headers: {
        Authorization: authorizationHeader,
...
const updateProjects = async (
  ...
  const res = await fetch(
    `${process.env.BACKEND_URL}/api/v1/candidate/profile/update/projects/${id}`,
    {
      method: "POST",
      headers: {
        Authorization: authorizationHeader,
